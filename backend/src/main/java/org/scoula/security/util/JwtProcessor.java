...
public class JwtProcessor {
    ...
    // private String secretKey = "GjKei5sBHynUrgcZQBwzOjPFGeKeMpnYKkcj+UzO+HwDb5dMiMWuVCwE8B03JZrhp2e0nN7wFxz0BDcgNvoJ9w==";
    private String secretKey = "mySuperSecretKeyForJWTShouldBeLongEnough";
